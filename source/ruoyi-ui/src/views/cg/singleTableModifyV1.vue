<template>
  <div class="app-container">
      <el-tabs v-model="activeName" type="card" >
        <el-tab-pane label="表配置" name="first">
            <el-row :gutter="10" class="mb8">
                ...
                <el-col :span="1.5">
                    <el-button type="warning" plain icon="el-icon-download" size="mini" :loading="false" @click="handleExport" v-hasPermi="['system:role:export']" >导出</el-button>
                </el-col>
                <right-toolbar :showSearch.sync="showSearch" @queryTable="getTable"></right-toolbar>
                </el-row>
                <el-row :gutter="20">
                <!--用户数据-->
                <el-col :span="20" :xs="24">
                    <el-table v-loading="loading" :data="tableList" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column label="表" align="center" prop="tableCode" width="160"> </el-table-column>
                        <el-table-column label="是否显示查询Form" align="center" prop="isShowRetrieveForm" width="160"> 
                            <template slot-scope="scope">
                                <el-switch v-model="scope.row.isShowRetrieveForm" active-value="1" inactive-value="0" 
                                ></el-switch>
                            </template>
                        </el-table-column>
        ...
        <el-tab-pane label="表字段管理" name="second" :disabled="tabFiledDisabled">
            <el-col :span="16" :gutter="20">
                <el-row :gutter="10" class="mb8">
                    <el-col :span="1.5">
                        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAddField" v-hasPermi="['system:role:add']">新增</el-button>
                    </el-col>
                    <el-col :span="1.5">
                        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdateField" v-hasPermi="['system:role:edit']" >修改</el-button>
                    </el-col>
                    <el-col :span="1.5">
                        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDeleteField" v-hasPermi="['system:role:remove']" >删除</el-button>
                    </el-col>
                    <el-col :span="1.5">
                        <el-button type="warning" plain icon="el-icon-download" size="mini" :loading="false" @click="handleExportField" v-hasPermi="['system:role:export']" >导出</el-button>
                    </el-col>
                    <right-toolbar :showSearch.sync="showSearch" @queryTable="getTable" style="margin-right:20px;"></right-toolbar>
                </el-row>
    ...
    <el-drawer
        ...
        direction="rtl">
        <el-row>
            <el-form :model="tableForm" ref="tableForm" :inline="false" label-width="150px">
...
import { getTable,createTable,deleteTable,updateTable,getTableField,createTableField,deleteTableField,updateTableField } from "@/api/cg/v1";
